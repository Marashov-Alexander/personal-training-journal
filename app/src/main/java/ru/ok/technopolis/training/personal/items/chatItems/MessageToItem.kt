...
class MessageToItem(@NonNull val message:MessageEntity, private val workout: ShortWorkoutItem?, private val ex: ShortExerciseItem?, private val router: Router) : Item<GroupieViewHolder>() {
